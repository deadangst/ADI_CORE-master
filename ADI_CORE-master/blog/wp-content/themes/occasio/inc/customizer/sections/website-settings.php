...
function occasio_customize_register_website_settings( $wp_customize ) {
	...
	$wp_customize->add_control( new Occasio_Customize_Header_Control(
		$wp_customize, 'occasio_theme_options[retina_logo_title]', array(
	...
	$wp_customize->add_setting( 'occasio_theme_options[retina_logo]', array(
		'default'           => false,
		'type'              => 'option',
		'transport'         => 'refresh',
	...
	$wp_customize->add_control( 'occasio_theme_options[retina_logo]', array(
	...
	$wp_customize->add_setting( 'occasio_theme_options[site_title]', array(
		'default'           => true,
		'type'              => 'option',
	...
	$wp_customize->add_control( 'occasio_theme_options[site_title]', array(
	...
	$wp_customize->add_setting( 'occasio_theme_options[site_description]', array(
		'default'           => true,
		'type'              => 'option',
		'transport'         => 'postMessage',
		'sanitize_callback' => 'occasio_sanitize_checkbox',
	...
	$wp_customize->add_control( 'occasio_theme_options[site_description]', array(
