<?php
if( !function_exists('multi_blog_custom_taxonomy_field') ):

	// Add term page
    function multi_blog_custom_taxonomy_field(){
        ...
        <div class="form-field">
            ...
            <label><?php esc_html_e('Feature Image', 'multi-blog'); ?></label>
...
add_action('category_add_form_fields', 'multi_blog_custom_taxonomy_field', 10, 2);


if( !function_exists('multi_blog_taxonomy_edit_meta_field') ):

	// Edit term page
    function multi_blog_taxonomy_edit_meta_field($term){

        $twp_term_image = get_term_meta( $term->term_id, 'twp-term-featured-image', true ); ?>
        <tr>
            
            <th scope="row" valign="top"><label><?php esc_html_e('Feature Image', 'multi-blog'); ?></label></th>
...
add_action('category_edit_form_fields', 'multi_blog_taxonomy_edit_meta_field', 10, 2);
